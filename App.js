...
Body
    ...
    Resturant container
        Resturant cards
            ...
            Name of restro
            Star Rating
            cuisines,delivery Time price range etc.
    ...
    return(
        <div className="body">
            ...
            <div className="rest-container">
                {/* //Rest Cards */}
                {/* <RestCard resName="Meghna Foods" cuisine="Biryani,South Indian " />
                <RestCard resName="KFC" cuisine="Burger,Fast Food "/> */}
{/* 
...
const Footer =() => {
    return (
        <div className="footer"> Made with &hearts; <strong>Ashish Kumar</strong></div>
    )
}
